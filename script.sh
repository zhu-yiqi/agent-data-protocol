...
export MY_DATASET=nebius_SWE-agent-trajectories #SWE-Gym_OpenHands-Sampled-Trajectories
echo $MY_DATASET
...
echo Step_3
cat datasets/$MY_DATASET/full_std.jsonl | python -u scripts/std_to_sft.py --is_web=no --chunk=all --keep_system=no --api_env=execute_ipython_cell
