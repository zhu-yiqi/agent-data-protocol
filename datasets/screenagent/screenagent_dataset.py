...
from datasets import GeneratorBasedBuilder, DatasetInfo, Sequence
from datasets.features import Features, Value, Image as hf_Image
...
_URL = (
    "https://codeload.github.com/niuzaisheng/ScreenAgent/zip/refs/heads/main"
)
...
class ScreenAgentDataset(GeneratorBasedBuilder):
    ...
    def _split_generators(self, dl_manager):
        ...
        train_data_dir = os.path.join(extracted_path, "ScreenAgent-main", "data", "ScreenAgent", "train")
    ...
    def _generate_examples(self, data_dir):
        ...
        for session_id in os.listdir(data_dir):
            ...
            step_paths.sort(key=lambda x: datetime.strptime(
                os.path.basename(x).split('_')[0] + '_' + os.path.basename(x).split('_')[1], '%Y-%m-%d_%H-%M-%S-%f'))
            ...
            for step_path in step_paths:
                ...
                with open(step_path, 'r') as f:
                    ...
                    if not "current_task" in one_step:
