...
credential_path = os.path.join(os.environ["HOME"], ".config/gcloud/application_default_credentials.json")
...
for dataset_name, directory in dataset_directories.items():
    ...
    for i, rcd in enumerate(dataset):
        ...
        image_file_name: str = "{}/{:}-{:d}".format(image_dir, json_dict["episode_id"], json_dict["step_id"])
