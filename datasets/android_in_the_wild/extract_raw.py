...
for i, rcd in enumerate(dataset):
    ...
    # image
    #parse_image_data( json_dict["image/encoded"][0], json_dict["image/height"][0]
                    #, json_dict["image/width"][0], json_dict["image/channels"][0]
                    #).show()
    json_dict["image/encoded"] = "<image>"
