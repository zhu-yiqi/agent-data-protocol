...
class EmulatorConfig(SimulatorConfig):
    ...
    adb_controller: AdbControllerConfig = dataclasses.field(default_factory=AdbControllerConfig)
...
class AndroidEnvConfig:
    ...
    task_manager: TaskManagerConfig = dataclasses.field(default_factory=TaskManagerConfig)
    coordinator: CoordinatorConfig = dataclasses.field(default_factory=CoordinatorConfig)
