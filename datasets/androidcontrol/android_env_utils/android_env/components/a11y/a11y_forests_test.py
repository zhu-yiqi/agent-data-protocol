...
def _empty_forest() -> android_accessibility_forest_pb2.AndroidAccessibilityForest:
    return android_accessibility_forest_pb2.AndroidAccessibilityForest()


def _one_empty_window_forest() -> android_accessibility_forest_pb2.AndroidAccessibilityForest:
    forest = android_accessibility_forest_pb2.AndroidAccessibilityForest()
    forest.windows.add()
    return forest


def _two_window_forest() -> android_accessibility_forest_pb2.AndroidAccessibilityForest:
    forest = android_accessibility_forest_pb2.AndroidAccessibilityForest()
    window = forest.windows.add()
    window.tree.nodes.add(class_name="foo", is_clickable=True, hint_text="Foo hint")
    forest.windows.add()
    return forest
