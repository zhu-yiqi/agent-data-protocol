...
def task_extras_has_forests(task_extras: Mapping[str, Any]) -> bool:
    ...
    return any(
        isinstance(f, android_accessibility_forest_pb2.AndroidAccessibilityForest) for f in payload
    )


def convert_to_forest(
    forest: android_accessibility_forest_pb2.AndroidAccessibilityForest | any_pb2.Any | None,
    ...
    if isinstance(forest, any_pb2.Any):
        ...
        return output
    elif isinstance(forest, android_accessibility_forest_pb2.AndroidAccessibilityForest):
        return forest
    else:
        return None
