...
class AndroidEnvTest(absltest.TestCase):
    def test_specs(self):
        ...
        self.assertIsInstance(env.action_spec()["action_type"], dm_env.specs.DiscreteArray)
        self.assertIn("touch_position", env.action_spec())
        self.assertIsInstance(env.action_spec()["touch_position"], dm_env.specs.BoundedArray)
        ...
        self.assertIsInstance(env.observation_spec()["timedelta"], dm_env.specs.Array)
        ...
        self.assertIsInstance(env.observation_spec()["orientation"], dm_env.specs.Array)
    ...
    def test_reset_and_step(self):
        ...
        coordinator.rl_reset.return_value = dm_env.TimeStep(
            ...
            observation={
                ...
                "extras": {"click": np.array([[246]], dtype=np.int64)},
            },
        )
