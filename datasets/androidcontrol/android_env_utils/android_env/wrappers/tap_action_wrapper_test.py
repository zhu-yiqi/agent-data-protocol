...
class TapActionWrapperTest(absltest.TestCase):
    ...
    def test_process_action_repeat(self):
        wrapped_env = tap_action_wrapper.TapActionWrapper(self.base_env, num_frames=3)
        action = {
    ...
    def test_process_action_touch(self):
        ...
        actions = wrapped_env._process_action(action)
        self.assertLen(actions, wrapped_env._num_frames + 1)
        self.assertEqual(actions[-1]["action_type"], np.array(action_type.ActionType.LIFT))

    def test_reset(self):
        wrapped_env = tap_action_wrapper.TapActionWrapper(self.base_env, num_frames=5)
        fake_timestep = "ts"
    ...
    def test_action_spec(self):
        ...
        self.assertEqual(self.base_env.action_spec(), action_spec)
